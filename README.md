...
[![HF Space](https://img.shields.io/badge/%F0%9F%A4%97-HF%20Space-yellow)](https://huggingface.co/spaces/Arun0808/trajprompt)
![traj-CLIP checkpoint scaffold](https://img.shields.io/badge/traj--CLIP-checkpoint%20scaffold-blue)
![AIS text-pair scaffold](https://img.shields.io/badge/AIS%20text%20pairs-dataset%20scaffold-orange)
...
[HF Space](https://huggingface.co/spaces/Arun0808/trajprompt) — Mapbox dark theme, free-text prompt, output is annotated trajectory traces + Sentinel-2 chips with SAM 2 masks.
